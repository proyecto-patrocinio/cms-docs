...
.
    ...
    \\
    \hline
    PAT-SYS-18& [MANUAL]: Creación de un consultante por Google Forms & 
    \begin{itemize}
        \item \textbf{Given} Existe el formulario de google ``Nuevo Consultante'' configurado con credenciales del usuario con permisos de formulario.
        \newline
    ...
    \begin{itemize}
        \item \textbf{Given} Existe el formulario de google ``Nueva Consulta'' configurado con credenciales del usuario con permisos de formulario.
    ...
    \begin{itemize}
        \item \textbf{Given} Existe el formulario de google ``Nuevo Hijo'' configurado con credenciales del usuario con permisos de formulario.
        \item \textbf{And} Existe el consultante con DNI ``11111111'' en base de datos.
        \newline
